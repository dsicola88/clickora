...
/**
 * Sinais de rede de anúncios sem ID de clique real (teste manual, macros literais, UTM só).
 * Não inventa «Pago» com GCLID — só evita rotular Ads como «Orgânico».
 */
...
/** paid = ID real; paid_untracked = Ads/UTM sem ID real; organic = sem sinais de ads. */
