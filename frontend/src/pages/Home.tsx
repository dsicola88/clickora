      ...
      <div className="grid w-full max-w-5xl grid-cols-1 gap-6 self-center md:grid-cols-2">
        ...
        >
          ...
          {isAdmin ? (
            ...
            <p className="text-sm text-muted-foreground mb-4">Páginas presell e publicação com link.</p>
          )}
        ...
        >
          ...
          {isAdmin ? (
            ...
            <p className="text-sm text-muted-foreground mb-4">Cliques, conversões e relatórios.</p>
          )}
